...
class APIListView(APIView):
    ...
    def get(self, request):
        apis = [
            {'id': 1, 'name': 'Celestial Bank', 'url': 'http://192.168.1.35:8000/api/celestial/report/ | http://192.168.1.35:8000/api/user/balance/ '},
            {'id': 2, 'name': 'Roberk Bank', 'url': 'http://192.168.1.35:8001/api/celestial/report/ | http://192.168.1.35:8001/api/user/balance/ '},
        ]
